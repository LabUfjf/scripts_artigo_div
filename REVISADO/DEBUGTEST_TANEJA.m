    ...
    for norm = {'full','fit'};
        ...
        for mod = {'real','abs'};
            ...
            for inter = {'linear','nearest'};
                ...
                %                         F1(i,:,:)=ar(V0,mod{1});
                %                         %=========================================================================
                %                         V1=ar(log(ar((P+Q)./ar(2*sqrt(P.*Q),mod{1}),mod{1})),mod{1});   % FUNÇÃO B
                %                         V1(isnan(V1)|isinf(V1))=0;
                %                         F2(i,:,:)=ar(V1,mod{1});
                %                         %=========================================================================
                %                         V2=ar(F1(i,:,:),mod{1}).*ar(F2(i,:,:),mod{1});  % JUNÇÃO DAS FUNÇÕES A E B
                ...
                for j =  length(sd):-1:1
                    ...
                    for i=1:nt
                        ...
                        F1(i,:)=ar(V0,mod{1});
                        %=========================================================================
                        V1=ar(log(ar((P+Q)./ar(2*sqrt(P.*Q),mod{1}),mod{1})),mod{1});
                        V1(isnan(V1)|isinf(V1))=0;
                        F2(i,:)=ar(V1,mod{1});
                        %=========================================================================
                        V2=ar(F1(i,:),mod{1}).*ar(F2(i,:),mod{1});
                        V2(isnan(V2)|isinf(V2))=0;
                        F3(i,:)=V2;
                        %=========================================================================
                        waitbar(i/nt);
