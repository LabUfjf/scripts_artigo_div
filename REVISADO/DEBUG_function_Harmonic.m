...
subplot(3,2,1);legend('(PQ)[1]','(PQ)[2]','(PQ)[3]');xlabel('data'); ylabel('Amplitude'); grid minor; axis tight;
subplot(3,2,2);legend('(P+Q)[1]','(P+Q)[2]','(P+Q)[3]');xlabel('data'); ylabel('Amplitude');grid minor; axis tight
subplot(3,2,3:4);legend('(PQ)/(P+Q)[1]','(PQ)/(P+Q)[2]','(PQ)/(P+Q)3]'); ylabel('Amplitude'); grid minor; axis tight
...
subplot(2,1,1); legend({'(PQ)[1]','(P+Q)[1]','(PQ)[2]','(P+Q)[2]','(PQ)[3]','(P+Q)[3]','Max/Min'},'Location','best');xlabel('Probability'); ylabel('Amplitude')
subplot(2,1,2); legend({'(PQ)/(P+Q)[1]','(PQ)/(P+Q)[2]','(PQ)/(P+Q)[3]'},'Location','best'); xlabel('Probability'); ylabel('Amplitude')
set(gcf,'units','points','position',[10,10,550,400])
