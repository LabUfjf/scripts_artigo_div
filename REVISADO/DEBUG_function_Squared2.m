...
subplot(2,2,2);legend('(P+Q)[1]','(P+Q)[2]','(P+Q)[3]');xlabel('Probability'); ylabel('Amplitude');grid minor; axis tight

subplot(2,2,3:4);legend('(P-Q)²/(P+Q)[1]','(P-Q)²/(P+Q)[2]','(P-Q)²/(P+Q)[3]');xlabel('Probability'); ylabel('Amplitude');
subplot(2,2,3:4); grid minor; axis tight
