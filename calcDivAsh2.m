function [DIV] = calcDivAsh2(DATA,IND,TARGET,sg,bg,N)
...
for nv = 1:size(DATA,1);
    ...
    for cvtr = 1:N.BLOCKS;
        ...
        [x.tr.sg,y.tr.sg]=ashNorm(DATASG.TR,M,calcnbins(DATASG.TR,'fd'));
        [x.tr.bg,y.tr.bg]=ashNorm(DATABG.TR,M,calcnbins(DATASG.TR,'fd'));
